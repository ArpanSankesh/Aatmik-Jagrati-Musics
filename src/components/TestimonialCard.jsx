export default function TestimonialCard({ testimonial }) {
    return (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 px-10">
            ...
            <p className="text-sm pt-4 text-gray-800">{testimonial.feedback}</p>
        </div>
    );
}
