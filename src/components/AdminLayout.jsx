...
  const linkClasses = "flex items-center gap-3 rounded-xl px-4 py-3 text-gray-600 transition-all hover:bg-gray-100 hover:text-gray-900 group relative";
  const activeLinkClasses = "flex items-center gap-3 rounded-xl px-4 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-white shadow-lg shadow-indigo-200 transition-all group relative";
...
          <div className="flex flex-col h-full">
            ...
            <div className="lg:hidden flex items-center justify-between px-4 py-3 border-b">
               ...
               <button onClick={closeMobileMenu} className="p-2 rounded-lg hover:bg-gray-100 transition">
                 <X size={24} />
               </button>
            </div>
...
                    {({ isActive }) => (
                      <>
                        <item.icon className={`h-5 w-5 ${isActive ? 'text-white' : 'text-gray-500 group-hover:text-indigo-600'} transition`} />
